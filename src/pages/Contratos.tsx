...
import { BarraNavContratos } from "../components/BarraNav/BarraNavContratos";
    ...
    <>
      ...
      >
        ...
        <h2>
          ...
          utlizar nuestra plataforma. Descubre todas las plantillas de contratos
          que tenemos disponbiles para ti.
          {/* En el siguiente video te explicamos cómo diligenciar un 
          contrato laboral de servicio doméstico.
        </h2>
